...
function helper() {
  _debugLog('[iface="traits:www-helper/helper@0.1.0", function="helper"][Instruction::CallWasm] enter', {
    funcName: 'helper',
    paramCount: 0,
    async: false,
    postReturn: true,
  ...
  _debugLog('[iface="traits:www-helper/helper@0.1.0", function="helper"][Instruction::Return]', {
    funcName: 'helper',
    paramCount: 1,
    async: false,
    postReturn: true
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./www_local_helper_component.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./www_local_helper_component.core2.wasm', import.meta.url));
    ...
    postReturn0 = exports1['cabi_post_traits:www-helper/helper@0.1.0#helper'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_traits:www-helper/helper@0.1.0#helper']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_traits:www-helper/helper@0.1.0#helper'];
    }
    
    helper010Helper = exports1['traits:www-helper/helper@0.1.0#helper'];
  })();
...
export { helper010 as helper, helper010 as 'traits:www-helper/helper@0.1.0',  }