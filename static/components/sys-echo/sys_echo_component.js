...
function echo(arg0) {
  ...
  _debugLog('[iface="traits:sys-echo/echo@0.1.0", function="echo"][Instruction::CallWasm] enter', {
    funcName: 'echo',
    paramCount: 2,
    async: false,
    postReturn: true,
  ...
  _debugLog('[iface="traits:sys-echo/echo@0.1.0", function="echo"][Instruction::Return]', {
    funcName: 'echo',
    paramCount: 1,
    async: false,
    postReturn: true
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./sys_echo_component.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./sys_echo_component.core2.wasm', import.meta.url));
    ...
    postReturn0 = exports1['cabi_post_traits:sys-echo/echo@0.1.0#echo'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_traits:sys-echo/echo@0.1.0#echo']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_traits:sys-echo/echo@0.1.0#echo'];
    }
    
    echo010Echo = exports1['traits:sys-echo/echo@0.1.0#echo'];
  })();
...
export { echo010 as echo, echo010 as 'traits:sys-echo/echo@0.1.0',  }