...
let install010Install;

function install() {
  _debugLog('[iface="traits:www-install/install@0.1.0", function="install"][Instruction::CallWasm] enter', {
    funcName: 'install',
    paramCount: 0,
    async: false,
    postReturn: true,
  ...
  _debugLog('[iface="traits:www-install/install@0.1.0", function="install"][Instruction::Return]', {
    funcName: 'install',
    paramCount: 1,
    async: false,
    postReturn: true
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./www_local_install_component.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./www_local_install_component.core2.wasm', import.meta.url));
    ...
    postReturn0 = exports1['cabi_post_traits:www-install/install@0.1.0#install'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_traits:www-install/install@0.1.0#install']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_traits:www-install/install@0.1.0#install'];
    }
    
    install010Install = exports1['traits:www-install/install@0.1.0#install'];
  })();
...
export { install010 as install, install010 as 'traits:www-install/install@0.1.0',  }