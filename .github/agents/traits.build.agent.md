...
4. **Terminal runtime generation** — strips ESM export from `terminal.js`, inlines CSS, and prepends `traits/www/terminal/shared/terminal.shared.js` for host-agnostic defaults
