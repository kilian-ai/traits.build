...
let checksum010Checksum;

function checksum(arg0, arg1) {
  ...
  _debugLog('[iface="traits:sys-checksum/checksum@0.1.0", function="checksum"][Instruction::CallWasm] enter', {
    funcName: 'checksum',
    paramCount: 4,
    async: false,
    postReturn: true,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'checksum010Checksum',
    getCallbackFn: () => null,
    callbackFnName: 'null',
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => checksum010Checksum(ptr0, len0, ptr1, len1),
  });
  ...
  _debugLog('[iface="traits:sys-checksum/checksum@0.1.0", function="checksum"][Instruction::Return]', {
    funcName: 'checksum',
    paramCount: 1,
    async: false,
    postReturn: true
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    ...
    postReturn0 = exports1['cabi_post_traits:sys-checksum/checksum@0.1.0#checksum'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_traits:sys-checksum/checksum@0.1.0#checksum']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_traits:sys-checksum/checksum@0.1.0#checksum'];
    }
    
    checksum010Checksum = exports1['traits:sys-checksum/checksum@0.1.0#checksum'];
  })();
...
export { checksum010 as checksum, checksum010 as 'traits:sys-checksum/checksum@0.1.0',  }