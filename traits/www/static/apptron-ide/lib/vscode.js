...
export class VSCodeWorkbenchComponent extends HTMLElement {
  ...
  mount() {
    ...
    nls.src = `${APPTRON_BASE}/vscode/out/nls.messages.js`;
    const loader = document.createElement("script");
    loader.src = `${APPTRON_BASE}/vscode/out/vs/loader.js`;
    ...
    const runBootstrap = () => {
      const go = () => {
        ...
        require.config({ baseUrl: window.location.origin + `${APPTRON_BASE}/vscode/out` });
