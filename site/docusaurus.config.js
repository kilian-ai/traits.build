    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://traits.build/docs/api',
            label: 'API Reference',
            position: 'left',
          },
          {
            href: 'https://traits.build',
            label: 'Live Demo',
            position: 'right',
          },
          {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              { label: 'API Docs (Redoc)', href: 'https://traits.build/docs/api' },
            ],
          },
          {
            title: 'Links',
            items: [
              ...
              { label: 'Live Instance', href: 'https://traits.build' },
              { label: 'Health Check', href: 'https://traits.build/health' },
            ],
          },
        ],
